...
const codingBuddyDirectives_1 = require("./codingBuddyDirectives");
...
async function getLLMJson(message) {
    ...
    const completion = await openai.chat.completions.create({
        ...
        messages: [
            {
                role: "system",
                content: codingBuddyDirectives_1.rulesets //Coding Buddy's Directives
            },
            {
                role: "system",
                content: codingBuddyDirectives_1.jsonFormat //Coding Buddy's Response Format
            },
            {
                role: "system",
                content: codingBuddyDirectives_1.codeExamples //Respose examples fed into Coding Buddy
            },
            {
                role: "system",
